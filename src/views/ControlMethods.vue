...
<template>
    <button @click="pause" id="pause">pause</button>
    <button @click="play" id="play">play</button>
    <button @click="reverse" id="reverse">reverse</button>
    <button @click="seek" id="seek">seek</button>
